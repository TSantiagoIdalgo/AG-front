  ...
  return (
    <figure className={showReview ? Style.review_show : Style.review}>
      ...
      <div className={Style.left}>
        ...
        <img alt="isRecommended" src={review.recommended ? LikeIcon : DislikeIcon}
      ...
      <div className={Style.user}>
        ...
        <div className={Style.usefull}>
          ...
          <div className={Style.votes}>
            <button type="button" className={isLiked ? Style.vote_like : Style.vote}
              onClick={handleLike}>
              <img alt="like" src={LikeIcon} className={Style.like_blank}/>
              <span className={Style.positive}>{countOfLikes}</span>
            </button>
            <button type='button' className={isDisliked ? Style.vote_dislike : Style.vote}
              onClick={handleDislike}>
              <img alt="dislike" src={DislikeIcon} className={Style.like_blank}/>
            </button>
          </div>
        </div>
      </div>
