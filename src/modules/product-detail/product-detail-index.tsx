...
import { ProductWithIsInWishlist } from '#src/common/interfaces/product.interface.ts';
...
export default function ProductDetailIndex(): React.JSX.Element {
  ...
  const { loading, data } = libs.useFetchData<ProductWithIsInWishlist>(PRODUCT_ENDPOINT.GET.findWithIsInWishlist(UUIDBase64.base64ToUuid(id as string)));
